...
class PostController extends Controller
{
    ...
    public function createPostAction(Request $request){
        ...
        $form = $this->createFormBuilder($post)
                ...
                ->add('save', SubmitType::Class, array('label' => 'Create Post', 'attr' => array('class' => 'btn btn-primary', 'style' => 'margin-top : 15px')))
                ->getForm();
    ...
    public function updatePostAction(Request $request, $id){
        ...
        $form = $this->createFormBuilder($post)
                ...
                ->add('description', TextareaType::Class, array('attr' => array('class' => 'form-control')))
                ->add('category', TextType::Class, array('attr' => array('class' => 'form-control')))
                ->add('save', SubmitType::Class, array('label' => 'Update Post', 'attr' => array('class' => 'btn btn-primary', 'style' => 'margin-top : 15px')))
                ->getForm();
